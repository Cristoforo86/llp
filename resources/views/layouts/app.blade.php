        ...
        <div class="container m-0 pr-0" id="navbar-container">
            ...
            <div class="navbar-btn">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Vocabulary List</a>
                        <a class="dropdown-item" href="#">Vocabulary Trainer</a>
                        <a class="dropdown-item" href="#">Conjugator</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">Grammar</a>
                    </div>
                </div>
            </div>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- <ul class="navbar-nav">
                        <div class="d-flex justify-content-start">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <h4><a class="nav-link" href="#">Italian</a></h4>
                                </li>
                                <li class="nav-item">
                                    <h4><a class="nav-link" href="#">German</a></h4>
                                </li>
                                <li class="nav-item">
                                    <h4><a class="nav-link" href="#">Spanish</a></h4>
                                </li>
                            </ul>
                        </div>
                    </ul> -->
